<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FlexiContentComponents.ascx.cs" Inherits="RockWeb.Plugins.church_vrl.FlexiContentComponents.FlexiContentComponents" %> 
                ...
                <Content>
                    ...
                    <div class="row">
                        ...
                        <asp:Panel ID="pnlContentChannelItemEdit" runat="server" CssClass="col-md-8">
                            ...
                            <div class="row">
                                <asp:Panel ID="pnlStartDate" runat="server" CssClass="col-md-6">
                                    <Rock:DateTimePicker ID="dtpStartDateTime" runat="server" Label="Start" ValidationGroup="vgContentComponentEditContentChannelItem" />
                                    <Rock:DatePicker ID="dpStartDate" runat="server" Label="Start" ValidationGroup="vgContentComponentEditContentChannelItem" />
                                </asp:Panel>
                                <asp:Panel ID="pnlExpireDate" runat="server" CssClass="col-md-6">
                                    <Rock:DateTimePicker ID="dtpExpireDateTime" runat="server" Label="Expire" ValidationGroup="vgContentComponentEditContentChannelItem" />
                                    <Rock:DatePicker ID="dpExpireDate" runat="server" Label="Expire" ValidationGroup="vgContentComponentEditContentChannelItem" />
                                </asp:Panel>
                            </div>
